                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', ['id' => $user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label class="col-md-4 col-form-label text-md-end mb-2" for="image">{{ __('プロフィール画像') }}</label>
                        ...
                        <div class="row mb-md-3 align-items-center">
                            ...
                            <div class="col-4 col-md-2 d-flex align-items-center mb-1">
                            ...
                            <label for="location_id" class="col-md-2 col-form-label text-md-end">{{ __('居住地') }}</label>
                        ...
                        <div class="row mb-1 mb-md-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('メールアドレス') }}<span class="badge text-bg-warning ms-2">非公開</span></label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-1 mb-md-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('変更後パスワード') }}<span class="badge text-bg-warning ms-2">非公開</span></label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-1 mb-md-3">
                            <label for="password_confirmation" class="col-md-4 col-form-label text-md-end">{{ __('変更後パスワード(確認)') }}<span class="badge text-bg-warning ms-2">非公開</span></label>
                            <div class="col-md-6">
                        ...
                        <div class="row mt-4 mt-md-5 justify-content-center">
                            <div class="col-10 col-md-7 offset-md-4">

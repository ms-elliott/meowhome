            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="pt-2 mx-2">
                    ...
                    <div class="row align-items-center">
                        <label class="col-md-2 text-sm font-medium text-md-end mb-2">年齢(推定)<span class="badge text-bg-primary ms-2">必須</span></label>
                        <div class="col-md-2 d-flex justify-content-between align-items-center mb-2">
                            ...
                            <label class="text-sm font-medium mx-md-1" for="age-year">歳</label>
                            ...
                            <label class="text-sm font-medium ms-md-1" for="age-month" style="width: 70px;">ヶ月</label>
                        </div>
                        <label class="col-md-2 text-sm font-medium text-md-end mb-2">性別<span class="badge text-bg-primary ms-2">必須</span></label>
                    ...
                    <div class="row align-items-center">
                        <label class="col-md-2 text-sm font-medium text-md-end" for="breed_id">種類</label>
                        ...
                        <label class="col-md-2 text-sm font-medium text-md-end" for="pattern_id">毛柄</label>
                        <div class="col-md-2 my-2">
                    ...
                    <div class="row mb-4 align-items-center">
                        <label class="col-md-2 text-sm font-medium text-md-end">ワクチン接種<span class="badge text-bg-primary ms-2">必須</span></label>
                        <div class="col-md-2 my-2">
                            <div class="form-check form-check-inline">
                        ...
                        <label class="col-md-2 text-sm font-medium text-md-end">去勢/避妊手術<span class="badge text-bg-primary ms-2">必須</span></label>
                        <div class="col-md-2 my-2">
                            <div class="form-check form-check-inline">
                    ...
                    <div class="row align-items-center">
                        <label class="col-md-2 text-sm font-medium text-md-end mb-md-3" for="location_id">所在地<span class="badge text-bg-primary ms-2">必須</span></label>
                        <div class="col-8 col-md-2 my-2 mb-3">
                        ...
                        <div class="col-12 col-md-4 d-flex">
                            <label class="text-sm font-medium text-md-end ms-md-5 mb-3">単身者応募<span class="badge text-bg-primary ms-2">必須</span></label>
                            <div class="ms-4">
                                <div class="form-check form-check-inline">
                        ...
                        <div class="col-12 col-md-4 d-flex mb-3">
                            <label class="text-sm font-medium text-md-end">高齢者応募<span class="badge text-bg-primary ms-2">必須</span></label>
                            <div class="ms-4">
                                <div class="form-check form-check-inline">
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-md-2 text-sm font-medium text-md-end">
                            <p class="mb-1">応募可能地域</p>
                        </div>
                        <div class="col-12 col-md-2 d-flex justify-content-start mb-1">
                        ...
                        <div class="row d-flex align-items-center">
                            <label class="col-md-2 text-sm font-medium text-md-end" for="title">タイトル<span class="badge text-bg-primary ms-2">必須</span></label>
                        ...
                        <div class="row mb-1">
                            <label class="col-md-2 text-sm font-medium text-md-end mt-md-2" for="body">本文<span class="badge text-bg-primary ms-2">必須</span></label>
                        ...
                        <div class="row mb-2">
                            <label class="col-md-2 text-sm font-medium text-md-end">写真</label>

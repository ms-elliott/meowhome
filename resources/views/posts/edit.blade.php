    ...
    <div class="container px-4 mx-auto">
        <div class="py-4 px-4 bg-white rounded">
            <form action="{{ route('posts.update', ['id' => $post->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex px-6 pb-md-2 border-b">
                ...
                <div class="pt-2 mx-2">
                    ...
                    <div class="row mb-4 align-items-center">
                        <label class="col-md-2 text-sm font-medium text-md-end mb-2" for="status">状況<span class="badge text-bg-primary ms-2">必須</span></label>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-10 col-md-2 d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="row mb-1 mb-md-3 align-items-center">
                        <div class="col-md-2 mb-2 text-md-end">
                        ...
                        <div class="col-12 col-md-4 d-flex">
                            <div class="mb-2 text-md-end">
                                <label class="text-sm font-medium ms-md-5">単身者応募<span class="badge text-bg-primary ms-2">必須</span></label>
                            </div>
                            <div class="ms-4 mb-2">
                                <div class="form-check form-check-inline">
                    ...
                    <div class="row mb-md-1 d-flex align-items-center">
                    ...
                    <div class="ml-auto d-flex justify-content-center mt-4 mt-md-5">
